...
<div class="col-xs-12" style="margin-top:10px;">
	<h3 class="col-xs-12 col-sm-2">Withdraw</h3>	
</div>
...
<form name="myForm" class="col-xs-12">
	<div class="col-xs-12 col-sm-4" id="mcard" ng-show="deporeq">
		<div class="col-xs-12" style="margin-bottom:10px;">
			<h3 class="heading col-xs-12 col-sm-6 pad-free">Withdraw Request</h3>
		...
		<div ng-show="muself">		
			<div class="form-group row">
					...
					<div class="col-xs-12 col-sm-7">
						<!-- <input type="text" name="mbankval" ng-model="mbankval" class="form-control"> -->
						<select ng-options="b.bname for b in mbank track by b.bank_history_id" ng-model="mbankval" class="form-control">
		...
		<div ng-show="mprofile">
				<div class="form-group row">
					...
					<div class="col-xs-12 col-sm-7">
						<select ng-options="b.bname for b in mbank track by b.bank_history_id" ng-model="mbankselect" class="form-control" ng-change="mcardselect(mbankselect)">
							<option value="">-- Choose Bank --</option>
						</select>
					</div>
				</div>
		...
		<div class="col-xs-12 pad-free" ng-show="allreq">
			...
			<div class="col-xs-12 col-sm-7 col-sm-offset-5 pad-free">
				<div class="col-xs-12 col-sm-6">
					<input type="button" ng-click='depoself("savewith")'  class="form-control btn all-btn" name="Request" value="Request" ng-disabled="depodisable" ng-disabled="myForm.amt.$valid==false?true:false" style="margin-bottom:5px;">		
				</div>
				<div class="col-xs-12 col-sm-6">
					<input type="button" ng-click='closewith()'  class="form-control btn all-btn" name="Close" value="Close" style="margin-bottom:5px;">	
				</div>				
...
<div class="col-xs-12" style="margin-bottom:10px;">
	...
	<div class="col-xs-12 col-sm-2" style="margin-top:10px;">
		<input type="text" class="form-control" name="filterDate" ng-model="allfilter.filterDate" id="date" datepicker placeholder="Date" style=" margin-bottom:10px;" ng-init="allfilter.filterDate=filterDate">
	</div>	
	<div class="col-xs-12 col-sm-2" style="margin-top:10px;" ng-show="bkname">
		<!-- <input type="text" class="form-control" name="filterBank" ng-model="filterBank" id="date" placeholder="Bank Name"> -->
...
<!-- <div class="col-xs-12" style="margin-top:20px; border:2px solid black; background:#ccc; padding:15px;">
	
	
</div> -->

<div class="col-xs-12" ng-show="withdrawshow">
	<div class="col-xs-12" id="withadmin">
		<div class="col-xs-12 pad-free" id="scrolldiv">
			...
			<tr>
				...
				<th ng-if="total=='Admin'">Member Name</th>
				<th>Name</th>
				<th>Bank</th>
				<th>Acc Number</th>
				<th>City</th>
			...
			<tr ng-repeat="x in wdt" ng-if="wdt != 'No Record' || wdt != ''">
				...
				<td ng-if="total=='Admin'">{{x.mname}}</td>
				<td>{{x.username}}</td>
				<td>{{x.bank}}</td>
				<td>{{x.acc_nrc}}</td>
				<td>{{x.city}}</td>
				<td>{{x.ph}}</td>
				<td>{{x.branch}}</td>
				<td class="famount numbers">- {{x.amount | number : fractionSize}}</td>
