...
<div id="black-overlay" class="col-xs-12 pad-free" style="position:fixed;"></div>
	<div class="col-xs-12 form-group">
		<h3 id="allh3" class="col-xs-12">Acc Goals</h3>
	</div>
	<div class="col-xs-12 col-sm-5">
		...
		<tr ng-repeat="x in names|filter:gtype">
			...
			<td>{{x.description}}</td>
			<td>{{x.formula}}</td>
			<td><label ng-click="editagoal(x,x.accgoal_id)" style="cursor:pointer;">Edit</label></td>
			<td><label ng-click="delagoal(x.accgoal_id)" style="cursor:pointer;">Delete</label></td>
		</tr>
		</table>
	</div>
		...
		<form class="form-horizontal row">
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-6">
						<input type="button" ng-click='saveagoal()' class="form-control btn all-btn" name="submit" value="Save" ng-show="showagoal">
					</div>

					<div class="col-sm-offset-3 col-sm-6">
						<input type="button" ng-click='eagoal()' class="form-control btn all-btn" name="edit" value="Edit" ng-show="!showagoal">
					</div>
				</div>
