		...
		<div class="col-xs-12 pad-free" ng-show="allreq">
			...
			<div class="col-xs-12 col-sm-7 col-sm-offset-5 pad-free">
				<div class="col-xs-12 col-sm-6">
					<input type="button" ng-click='depoself("savedepo")'  class="form-control btn all-btn" name="Request" value="Request" ng-disabled="depodisable" ng-disabled="myForm.amt.$valid==false?true:false" style="margin-bottom:5px;">
				</div>
				<div class="col-xs-12 col-sm-6">
...
<div class="col-xs-12" style="margin-bottom:10px;">
	...
	<div class="col-xs-12 col-sm-2" style="margin-top:10px;" ng-show="bkname">
		...
		<select ng-options="b.bname for b in bank track by b.bank_history_id" ng-model="allfilter.filterBank" class="form-control" ng-init="allfilter.filterBank=bank[0]">
		</select>
	</div>	
	<div class="col-xs-12 col-sm-2" style="margin-top:10px;" ng-show="statusname">
