	...
	<div class="col-xs-12 col-sm-4" id="mcard" ng-show="deporeq">
		...
		<div class="col-xs-12 pad-free" ng-show="allreq">
			...
			<div class="col-xs-12 col-sm-7 col-sm-offset-5 pad-free">
				<div class="col-xs-12 col-sm-6">
					<input type="button" ng-click='depoself("savewith")'  class="form-control btn all-btn" name="Request" value="Request" ng-disabled="myForm.amt.$valid==false?true:false" style="margin-bottom:5px;">		
				</div>
				<div class="col-xs-12 col-sm-6">
