	...
	<h3 class="heading" style="margin-bottom:20px;">Transfer Request</h3>
		...
		<div class="col-xs-12 col-sm-6 col-sm-offset-6 pad-free">
			<div class="col-xs-12 col-sm-7">
				<input type="button" ng-click='depoself("savetran")'  class="form-control btn all-btn" name="Request" value="Request" ng-disabled="myForm.amt.$valid==false?true:false">
			</div>				
		</div>		
	</div>
		...
		<div class="col-xs-6">
			<div class="col-xs-12 col-sm-6 col-sm-offset-6 pad-free">
				<div class="col-xs-12 col-sm-7 pull-right" style="margin-top:10px;">
					<input type="button" ng-click='admindepoself()'  class="form-control btn all-btn" name="Transfer" value="Transfer" ng-disabled="myForm.amt.$valid==false?true:false">
				</div>				
			</div>
		</div>
	</div>
