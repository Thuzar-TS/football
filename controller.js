      ...
      $scope.pinall = function(){
        ...
        if (c == true) {
          ...
          /* for (var i =ar.length - 1; i >= 0; i--) {            
           ...
           $http.post("query.php",{"type":"checkmixmatch","btn":"pinall", "arraydata":ar})            
            .then(function(response){ 
              console.log(response.data);
            })
        }
...
.controller("mixbgledgerController", function($scope, $http, $filter, $location,$interval, $log, $routeParams){
if (window.localStorage.getItem("roleId")) {    
     if (window.localStorage.getItem("roleId")==1 || window.localStorage.getItem("roleId")==2) {
        if (window.localStorage.getItem("roleId")==2) {
          $scope.adshow=2;
        ...
        $("#wrapper").css("display","block");       
            ...
            $http.post("query.php", {"type":"mixbgledger", "btn":""})
            .then(function(response){
              console.log(response.data);
